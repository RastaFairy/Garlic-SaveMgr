...
public static class PayloadCompatibility
{
    ...
    /// <summary>SHA-256 esperado para el binario de referencia v1.13.</summary>
    public const string CurrentSha256 = "b6d366f4101fa2fcc14a353d083ef7e45e1cc86ef457bb20502bd8680dce4d73";

    // ── Utilidades ──────────────────────────────────────────────────────────────

    /// <summary>
    /// Calcula el SHA-256 del archivo en <paramref name="path"/> y lo compara con
    /// <see cref="CurrentSha256"/>.
    /// </summary>
    public static bool VerifyElf(string path, out string sha256)
    {
        ...
        try
        {
            ...
            return string.Equals(sha256, CurrentSha256, StringComparison.OrdinalIgnoreCase);
        }
        catch (Exception ex)
        {
