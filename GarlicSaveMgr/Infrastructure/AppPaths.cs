...
public static class AppPaths
{
    ...
    /// <summary>Papelera local del PC: recibe las copias locales retiradas de la lista activa, junto al ejecutable.</summary>
    public static string PcTrashDirectory => Path.Combine(RootDirectory, "pc_trash");
    ...
    /// <summary>Temas XML personalizados; el tema estándar vive embebido en el ensamblado.</summary>
    public static string ThemesDirectory => Path.Combine(RootDirectory, "Themes");
    /// <summary>Módulos opcionales de interfaz cargados en modo Detallada.</summary>
    public static string ModulesDirectory => Path.Combine(RootDirectory, "Modules");
    /// <summary>Temporales de trabajo para preparar respaldos internos antes de borrar.</summary>
    public static string InternalBackupTempDirectory => Path.Combine(BaseDirectory, "internal_backup_temp");
    /// <summary>Índice y manifiestos del Snapshot Engine (no duplica automáticamente los IMG).</summary>
    public static string SnapshotsDirectory => Path.Combine(BaseDirectory, "snapshots");
    public static string SnapshotsIndexFile => Path.Combine(SnapshotsDirectory, "index.json");
    ...
    public static void EnsureDirectories()
    {
        ...
        Directory.CreateDirectory(PcTrashDirectory);
        ...
        Directory.CreateDirectory(InternalBackupTempDirectory);
